export default class Card {
  ...
  getManaSymbols() {
    ...
    let extracted
    let results = []
    while ((extracted = regx.exec(this.manaCost)) !== null) { //eslint-disable-line
  ...
  getAbilities(text) {
    ...
    let extracted
    let italics = {}
    while ((extracted = regx1.exec(text)) !== null) { //eslint-disable-line
    ...
    let regx2 = /{(.+?)}/ig
    let symbols = {}
    while ((extracted = regx2.exec(text)) !== null) { //eslint-disable-line
