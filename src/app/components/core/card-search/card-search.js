  ...
  config = {
    ...
    cost: {
      ...
      steps: [
        {
          title: `0 to 1`,
          content: `<i class="ms ms-0 ms-cost ms-fw"></i><em>-</em><i class="ms ms-1 ms-cost ms-fw"></i>`
        },
        {
          title: `2 to 3`,
          content: `<i class="ms ms-2 ms-cost ms-fw"></i><em>-</em><i class="ms ms-3 ms-cost ms-fw"></i>`
        },
        {
          title: `4 to 5`,
          content: `<i class="ms ms-4 ms-cost ms-fw"></i><em>-</em><i class="ms ms-5 ms-cost ms-fw"></i>`
        },
        {
          title: `6 or More`,
          content: `<i class="ms ms-6 ms-cost ms-fw"></i><em>-</em><i class="ms ms-x ms-cost ms-fw"></i>`
        }
      ],
      selected: false
    },
    ...
    loyalty: {
      ...
      steps: [
        {
          title: `2 to 3`,
          content: `<i class="ms ms-loyalty-start ms-loyalty-2"></i><em>-</em><i class="ms ms-loyalty-start ms-loyalty-3"></i>`
        },
        {
          title: `4 to 5`,
          content: `<i class="ms ms-loyalty-start ms-loyalty-4"></i><em>-</em><i class="ms ms-loyalty-start ms-loyalty-5"></i>`
        },
        {
          title: `6 to 7`,
          content: `<i class="ms ms-loyalty-start ms-loyalty-6"></i><em>-</em><i class="ms ms-loyalty-start ms-loyalty-7"></i>`
        }
      ],
      selected: false
    },
    formats: {
      name: `Formats`,
      options: [{ name: `Only Legal`, value: false }],
      items: [],
      logic: true,
      excluded: true
    },
